...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Hazir Deil', 'https://t.me/ElnurGenCeLi')],
                    ),
                    link_preview=False
                   )
...
print("Bot aktifdi bot hakda məlumatı @ElnurGenCeLi dan ala bilərsən Versiya 1.7.5")
